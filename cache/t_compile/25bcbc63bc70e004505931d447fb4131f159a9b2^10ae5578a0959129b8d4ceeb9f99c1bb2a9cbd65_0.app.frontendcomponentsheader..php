<?php
/* Smarty version 4.1.0, created on 2023-07-20 09:13:31
  from 'app:frontendcomponentsheader.' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_64b8fabba92882_97301857',
...
function content_64b8fabba92882_97301857 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/dikm8638/public_html/ejournal.dikmatyasika.com/lib/pkp/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),));
...
?>
			...
			<div class="pkp_head_wrapper" style="background:white;">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/">Beranda</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/index.php/index/about">Tentang Kami</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/index.php/index/login">Login</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/index.php/index/search">Cari</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/index.php/index/issue/current">Terkini</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/index.php/index/issue/archive">Arsip</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://ejournal.dikmatyasika.com/index.php/index/announcement">Informasi</a>
        </li>
      </ul>
      <!-- Left links -->
    </div>
...
<!-- Navbar -->
				<!-- -->
				<!--
				<nav class="pkp_site_nav_menu mt-2" aria-label="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"common.navigation.site"),$_smarty_tpl ) ) ));?>
">
					<a id="siteNav"></a>
