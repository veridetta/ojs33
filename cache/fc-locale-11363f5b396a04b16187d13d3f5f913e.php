...
<li>Secara default hanya artikel yang berisi <em>semua</em> istilah dalam query akan ditampilkan (misalnya, tambahkan <em>DAN</em>)</li>
...
<li>Gunakan tanda <strong>*</strong> jika ingin menghasilkan semua urutan karakter; contoh: <em>soci*</em> morality akan cocok dengan dokumen yang berisi "sociological" atau "societal"</li>
</ul>',
  ...
  'payment.requestPublicationFee' => 'Ajukan permintaan pembayaran pembayaran ({$feeAmount})',
  ...
  'installer.updatingInstructions' => 'Jika Anda meng-upgrade OJS yang telah terpasang sebelumnya, <a href="{$upgradeUrl}">klik di sini</a> untuk memproses.',
